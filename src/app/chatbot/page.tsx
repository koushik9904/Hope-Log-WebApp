...
const ChatComponent = () => {
  ...
  return (
    <div className="bg-dark text-white max-h-screen flex justify-center px-4 sm:px-6 lg:px-8 mt-10 relative">
      ...
      <div className="md:w-9/12 w-full h-[60vh] bg-dark rounded-lg p-6 space-y-4">
        {messages.length === 0 ? (
              ...
              >
                <div>
                  ...
                  <div
                    className={`${
                      message.sender === "user:"
                        ? "bg-message bg-opacity-50"
                        : ""
                    } text-white p-4 mt-2 rounded-lg`}
                  >
        ...
        <div className="w-full p-4 bg-dark">
          <div className="flex w-full relative">
            ...
            <div className="absolute bottom-2 right-2 flex gap-2">
              ...
              >
                <Image src={LoginCircleSVG} alt="Send" />
              </button>
            </div>
          </div>
